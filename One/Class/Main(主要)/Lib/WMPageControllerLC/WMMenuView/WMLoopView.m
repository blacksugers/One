...
- (void)addPageControlWithPage{
    ...
    UIPageControl *pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(kScreenSize.width/2-50, 0, width, kPageH)];
